...
class MultilingualIndicConfig(IndicTrainConfig):
    csv_path: str = "./IndicFinetuning/multilingual_indic/first_real_run/dataset/metadata.csv"
    wav_dir: str = "./IndicFinetuning/multilingual_indic/first_real_run/dataset/wavs"
    preprocessed_dir: str = "./IndicFinetuning/multilingual_indic/first_real_run/dataset/preprocess"
    output_dir: str = "./IndicFinetuning/outputs/multilingual_indic_first_real_run"
